<template>
  <div class="company-container">
    <el-tabs>
      <el-tab-pane label="私海客户管理">
        <!-- 顶部按钮 -->
        <div class="button-group">
          <el-button type="primary" @click="openCreateDialog(0)">创建客户</el-button>
      ...
      <el-tab-pane label="公海客户管理">
        <!-- 顶部按钮 -->
        <div class="button-group">
          <el-button type="primary" @click="openCreateDialog(1)">创建客户</el-button>
          <el-button>导入</el-button>
        </div>
    ...
    <!-- 查看客户对话框 -->
    <el-dialog title="客户详情" v-model="dialogVisible" width="50%">
      <el-form label-width="120px">
        <!-- 客户名称信息 -->
        <el-form-item label="客户名称">
          <el-input placeholder="请输入客户名称" disabled/>
        </el-form-item>

        <!-- 客户邮箱信息 -->
        <el-form-item label="客户邮箱">
          <el-input placeholder="请输入客户邮箱" disabled/>
        </el-form-item>
    ...
    <!-- 创建客户对话框 -->
    <el-dialog title="创建客户" v-model="createDialogVisible" width="40%">
      <el-form label-width="120px">
        <!-- 可见范围单选按钮组 -->
    ...
    <!-- 修改客户权限框 -->
    <el-dialog title="修改客户权限" v-model="updateDialogVisible" width="40%">
      <el-form label-width="120px">
    ...
    <!-- 修改客户信息框 -->
    <el-dialog title="修改客户" v-model="updateUserDialog" width="40%">
      <el-form label-width="120px">
        <!-- 可见范围单选按钮组 -->
...
const checkList = ["自动发送邮件管理","邮件模版管理","文件管理","历史记录管理",
  "公司管理","部门管理","岗位管理","客户管理","商品管理","客户管理","客户管理","国家管理","区域管理"];
